# Generated by Django 5.0.4 on 2024-07-14 14:15
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Sub_Topic',
            fields=[
                ('sub_topic_id', models.BigAutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quiz_date', models.DateTimeField(blank=True, default=datetime.datetime.now)),
                ('mark', models.IntegerField()),
                ('total_number_of_questions', models.IntegerField()),
                ('result_percentage', models.DecimalField(decimal_places=1, max_digits=10, null=True)),
                ('subtopic', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='quiz_app.sub_topic')),
            ],
        ),
        migrations.CreateModel(
            name='Question',
